...
<style>
	...
	.sp--right { right: 24px; flex-direction: row-reverse; }
	.sp--left  { left: 24px;  flex-direction: row; }
	...
	.sp--right .sp-dot { flex-direction: row-reverse; }
	.sp--left  .sp-dot { flex-direction: row; }
