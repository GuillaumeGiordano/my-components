...
>
	<div class="ss-sticky">
		...
		<div class="ss-dots" aria-hidden="true">
			{#each slides as _, i}
				<div class="ss-dot" class:ss-dot--active={i === activeIdx} class:ss-dot--done={i < activeIdx}>
					<div
						class="ss-dot-bar"
...
<style>
	...
	@media (max-width: 640px) {
		.ss-layout { grid-template-columns: 1fr; padding: 32px 24px; }
	}
	...
	/* ── Right (visual) ── */
	.ss-right { position: relative; min-height: 280px; }
	...
	.ss-dot--done .ss-dot-bar { transform: scaleX(1); }
