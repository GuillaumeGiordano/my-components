...
<style>
  ...
  .sr--zoom.sr--revealed :global(> *) {
    opacity: 1;
    transform: scale(1);
  }

  /* ── slide-right ── */
  .sr--slide-right :global(> *) {
    opacity: 0;
    transform: translateX(-32px);
  }
  .sr--slide-right.sr--revealed :global(> *) {
    opacity: 1;
