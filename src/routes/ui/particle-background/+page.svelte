...
<div class="page">
  <div class="page-header">
    ...
    <p>Réseau de particules animées sur canvas — particules connectées par des lignes si assez proches.</p>
  </div>
  ...
  <section class="variant">
    ...
    <ParticleBackground>
      <div class="hero">
        ...
        <p class="hero-sub">60 particules, connexions à moins de 120px, couleur primaire du thème.</p>
      </div>
    </ParticleBackground>
  </section>
  ...
  <section class="variant">
    ...
    <ul class="notes">
      ...
      <li>L'animation est nettoyée proprement au démontage (<code>cancelAnimationFrame</code>).</li>
      <li>Les particules rebondissent sur les bords — algorithme O(n²) optimisé (paires uniques).</li>
      <li>Pour les couleurs, <code>var(--css-var)</code> est résolu au montage — pas réactif aux changements de thème dynamiques.</li>
    </ul>
  </section>
</div>
...
<style>
  ...
  .hero-title--sm   { font-size: 1.25rem; }
