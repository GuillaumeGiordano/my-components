...
<svelte:head>
  <title>CTA Banner — Sections</title>
</svelte:head>

<div class="page">
  <div class="page-header">
    <h1>CTA Banner</h1>
    <p>Bandeau d'appel à l'action centré avec trois variantes : default (fond neutre), primary (couleur accent) et dark (fond sombre).</p>
  </div>
  ...
  <CTABannerSection
    ...
    secondaryCta={{ label: 'Voir une démo', href: '#' }}
  />
  ...
  <CTABannerSection
    ...
    secondaryCta={{ label: 'Comparer les plans', href: '#' }}
  />
  ...
  <CTABannerSection
    ...
    secondaryCta={{ label: 'Consulter la FAQ', href: '#' }}
  />
</div>
