...
<style>
	...
	.hs-title    { margin: 0; font-size: clamp(1.4rem, 3vw, 2rem); font-weight: 800; color: var(--text-heading); }
	.hs-subtitle { margin: 4px 0 0; font-size: 14px; color: var(--text-muted); }
