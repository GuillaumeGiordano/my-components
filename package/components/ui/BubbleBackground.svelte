<script lang="ts">
	...
	function init() {
		...
		bubbles = Array.from({ length: bubbleCount }, (_, i) => mkBubble(i < bubbleCount * 0.7));
	}
	...
	function draw() {
		...
		for (const b of bubbles) {
			...
			if (b.y + b.r < 0) {
				...
				b.x = nb.x; b.y = nb.y; b.r = nb.r; b.vx = nb.vx; b.vy = nb.vy;
			}
...
<style>
	...
	.bb-canvas { position: absolute; inset: 0; width: 100%; height: 100%; pointer-events: none; }
