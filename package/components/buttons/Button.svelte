...
<style>
	...
	/* ---- Icon-only square ---- */
	.btn-sm.icon-only { padding: 5px; width: 28px; height: 28px; }
	.btn-md.icon-only { padding: 8px; width: 36px; height: 36px; }
	.btn-lg.icon-only { padding: 11px; width: 44px; height: 44px; }
